...
- v3.1 Design Polish & Audit Fixes -- TBD (planning)
...
### v3.1 Design Polish & Audit Fixes (Planning)

**Source:** Full-site UI audit (`.planning/ui-reviews/UI-REVIEW-FULL-SITE.md`, score 17/24, 14 ROI-ranked actions)

Phases TBD — to be defined via `/gsd-new-milestone v3.1`.
...
| 31. Performance Optimization | v3.0 | 2/2 | Complete | 2026-04-05 |
