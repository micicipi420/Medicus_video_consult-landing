...
**Milestone Goal:** Optimize the site for search engines and performance, add a 404 error page, fix UI inconsistencies across all pages, and bring all pages into full WCAG AA compliance with the design system.
