# Requirements Archive: v1.0 MedicusUnion KZ
...
- [x] **STRUC-01**: Сайт содержит все 11 секций по ТЗ: Hero, Проблема, Что вы получите, Как это работает, Кто консультирует, Почему через нас, Когда нужна консультация, Стоимость, Форма заявки, FAQ, Финальный призыв + Footer
...
| Профили врачей на сайте | Создаёт burden по обновлению. Ссылка на medicusunion.com/doctors |
