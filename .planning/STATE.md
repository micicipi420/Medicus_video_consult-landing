...
stopped_at: v6.0 roadmap created -- 9 phases (59-67) from 17 requirements
...
Phase: 59 (first of 9 in v6.0 milestone)
Plan: 0 of TBD in current phase
Status: Ready to plan
Last activity: 2026-04-10 -- v6.0 roadmap created, 9 phases (59-67) derived from 17 requirements
