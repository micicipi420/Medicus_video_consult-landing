  ...
  return (
    <section className="container mx-auto px-4 lg:px-6 mb-16" id="pricing">
      ...
      <div className="bg-[var(--glass-section-fill)] backdrop-blur-[var(--glass-section-blur)] rounded-[3rem] p-8 md:p-12 border border-white/60 shadow-glass-lg max-w-xl mx-auto">
        ...
        <a href="#form" className="w-full bg-gradient-to-r from-mu-cta-brand-from to-mu-cta-brand-to text-white py-4 rounded-2xl font-bold shadow-[0_16px_32px_color-mix(in_oklch,var(--color-mu-blue)_30%,transparent)] hover:shadow-[0_20px_40px_color-mix(in_oklch,var(--color-mu-blue)_40%,transparent)] transition-all flex items-center justify-center gap-2 text-lg">
